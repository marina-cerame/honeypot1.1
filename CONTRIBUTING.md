...
git remote add upstream https://github.com/TheBearQuarium/honeypot1.1.git
Cut a namespaced feature branch from master
...
Read more about making great commit messages here: http://karma-runner.github.io/0.8/dev/git-commit-msg.html
